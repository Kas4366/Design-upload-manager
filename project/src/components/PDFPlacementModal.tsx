...
export function PDFPlacementModal({ order, onClose, onSavePosition }: PDFPlacementModalProps) {
        ...
        <div className="flex-1 overflow-auto p-6 bg-gray-100">
          <div className="flex justify-center">
            ...
            >
              ...
              <div
                className="absolute order-number-text cursor-move bg-yellow-200 bg-opacity-75 px-2 py-1 rounded border-2 border-yellow-400 select-none"
                style={{
                  left: `${position.x}px`,
                  top: `${position.y}px`,
